...
def is_failing(student: Student) -> bool:
    ...
    """
    return True if student.average_grade < 1 else False
...
def succeeding_students(student_list: list) -> list:
    ...
    """
    return [student for student in student_list if student.average_grade > 1]
...
def sort_by_best_grade(student_list: list) -> list:
    ...
    """
    return sorted([student for student in student_list if student.average_grade > 1],
                  key=lambda x: (-x.average_grade, x.name))
